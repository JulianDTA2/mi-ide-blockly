...
Blockly.Arduino.Boards.profiles.esp8266_huzzah = {
  ...
  spi: [['SPI', 'SPI']],
  analogPins: Blockly.Arduino.Boards.profiles.esp32_dev.analogPins,
  digitalPins: Blockly.Arduino.Boards.profiles.esp32_dev.digitalPins,
  pwmPins: Blockly.Arduino.Boards.profiles.esp32_dev.pwmPins,
  serial: Blockly.Arduino.Boards.profiles.esp32_dev.serial,
  serialPins: Blockly.Arduino.Boards.profiles.esp32_dev.serialPins,
  serialSpeed: Blockly.Arduino.Boards.profiles.esp32_dev.serialSpeed,
  spi: Blockly.Arduino.Boards.profiles.esp32_dev.spi,
  spiPins: Blockly.Arduino.Boards.profiles.esp32_dev.spiPins,
  spiClockDivide: Blockly.Arduino.Boards.profiles.esp32_dev.spiClockDivide,
  i2c: Blockly.Arduino.Boards.profiles.esp32_dev.i2c,
  i2cPins: Blockly.Arduino.Boards.profiles.esp32_dev.i2cPins,
  i2cSpeed: Blockly.Arduino.Boards.profiles.esp32_dev.i2cSpeed,
  builtinLed: Blockly.Arduino.Boards.profiles.esp32_dev.builtinLed,
  interrupt: Blockly.Arduino.Boards.profiles.esp32_dev.interrupt
};
